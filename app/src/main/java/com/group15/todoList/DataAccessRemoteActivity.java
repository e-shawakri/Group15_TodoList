...
import com.group15.todoList.webview.ChromeWebViewItemDetailsActivity;
import com.group15.todoList.webview.WebViewItemDetailsActivity;
				...
				public void onItemClick(AdapterView<?> adapterView,
					...
					if (accessorId != -1) {
						intent = new Intent(DataAccessRemoteActivity.this,
								com.group15.todoList.ItemListActivity.class);
